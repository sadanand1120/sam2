...
from sam2.server.api_servers import clip_app, set_api_key


def main():
    parser = argparse.ArgumentParser(description="SAM2 CLIP Features API Server")
