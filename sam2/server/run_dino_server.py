...
from sam2.server.api_servers import dino_app, set_api_key


def main():
    parser = argparse.ArgumentParser(description="SAM2 DINO Features API Server")
